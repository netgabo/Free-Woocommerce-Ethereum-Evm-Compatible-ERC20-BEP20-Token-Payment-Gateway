...
function erc20_init_gateway_class() {
	...
	class WC_Token_Gateway extends WC_Payment_Gateway {
		...
		public function __construct() {
			 ...
			 * description
			 */
			$this->method_description = __('If you want to use this Payment Gateway, We suggest you read <a href="https://inkerk.ccom/woocommerce-ethereum-evm-token-payment-gateway-plugin/">our guide </a> before.', 'woocommerce-ethereum-evm-token-payment-gateway');
