<?php
/*
 * Plugin Name: Ethereum EVM compatible Blockchain  ERC20-BEP20 Token Payment Gateway
 * Version: 0.0.1
...
function erc20_init_gateway_class() {
	...
	class WC_Token_Gateway extends WC_Payment_Gateway {
		...
		public function __construct() {
			 ...
			 * description
			 */
			$this->method_description = __('If you want to use this Payment Gateway, We suggest you read <a href="https://github.com/AlgoNetwork/Woocommerce-Ethereum-Evm-Compatible-ERC20-BEP20-Token-Payment-Gateway/">our guide </a> before.', 'woocommerce-ethereum-evm-token-payment-gateway');
